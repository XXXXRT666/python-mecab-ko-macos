...
def test_parse(mecab: MeCab):
    ...
    assert mecab.parse("나의 꿈은 맑은 바람이 되어서") == [
        ...
        Morpheme(span=Span(3, 4), surface="꿈", feature=Feature(pos="NNG", semantic="행위", has_jongseong=True, reading="꿈")),
    ...
    assert mecab.parse("흙에서 자란 내 마음 파아란 하늘빛") == [
        ...
        Morpheme(span=Span(7, 8), surface="내", feature=Feature(pos="MM", semantic="~명사", has_jongseong=False, reading="내")),
        ...
        Morpheme(
            span=Span(16, 19),
            surface="하늘빛",
            feature=Feature(pos="NNG", has_jongseong=True, reading="하늘빛", type="Compound", expression="하늘/NNG/*+빛/NNG/*"),
        ),
    ]
